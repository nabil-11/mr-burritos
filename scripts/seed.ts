...
async function upsert(Model: any, filter: object, data: object) {
...
async function main() {
  ...
  for (const s of supplementData) {
    ...
    supIds[s.nameFr] = doc._id
    const priceStr = s.price > 0 ? `+${s.price} DT` : 'gratuit'
    console.log(`   ✓ ${s.nameFr.padEnd(20)} ${priceStr.padEnd(10)} [${s.type}]`)
  }
  ...
  const products = [
    // ── TACOS ────────────────────────────────────────────────────────────────
    {
      ...
      price: 10.9, category: cats.tacos, supplements: ALL,
    },
    {
    ...
    },
    {
      ...
      price: 11.9, category: cats.tacos, supplements: ALL,
    },
    {
    ...
    },
    {
      ...
      price: 13.9, category: cats.tacos, supplements: ALL,
    },
    ...
    // ── BURRITOS ─────────────────────────────────────────────────────────────
    {
      ...
      price: 11.9, category: cats.burritos, supplements: BURR,
    },
    {
    ...
    },
    {
      ...
      price: 13.9, category: cats.burritos, supplements: BURR,
    },
    ...
    // ── SNACKS ───────────────────────────────────────────────────────────────
    {
      ...
      price: 16.5, category: cats.snacks, supplements: SNACK,
    },
    {
      name:        { fr: 'Poppers Box',                ar: 'بوبرز بوكس'              },
      description: { fr: '6 Pièces de boulette fromage',
                     ar: '6 قطع بولية جبنة' },
      price: 5.9, category: cats.snacks, supplements: SNACK,
    },
    {
      name:        { fr: 'Nuggets Box 6 pièces',       ar: 'نوجيتس بوكس 6 قطع'      },
      description: { fr: 'Nuggets — 6 Pièces', ar: 'نوجيتس — 6 قطع' },
      price: 5.9, category: cats.snacks, supplements: SNACK,
    },
    {
      name:        { fr: 'Nuggets Box 10 pièces',      ar: 'نوجيتس بوكس 10 قطع'     },
      description: { fr: 'Nuggets — 10 Pièces', ar: 'نوجيتس — 10 قطع' },
      price: 9.9, category: cats.snacks, supplements: SNACK,
    },
    {
      name:        { fr: 'Chicken Fingers Box 8 pièces',  ar: 'تشيكن فينجرز بوكس 8 قطع'  },
      description: { fr: 'Chicken Fingers — 8 Pièces', ar: 'تشيكن فينجرز — 8 قطع' },
      price: 5.9, category: cats.snacks, supplements: SNACK,
    },
    {
      name:        { fr: 'Chicken Fingers Box 12 pièces', ar: 'تشيكن فينجرز بوكس 12 قطع' },
      description: { fr: 'Chicken Fingers — 12 Pièces', ar: 'تشيكن فينجرز — 12 قطع' },
      price: 8.9, category: cats.snacks, supplements: SNACK,
    },
    ...
    // ── BOISSONS ─────────────────────────────────────────────────────────────
    {
      ...
      price: 2.5, category: cats.boissons, supplements: [],
    },
    {
  ...
  for (const p of products) {
    ...
    console.log(`   ✓ ${p.name.fr.padEnd(35)} ${p.price} DT`)
  }
