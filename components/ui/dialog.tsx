  ...
  return (
    <DialogPortal>
      ...
      <DialogPrimitive.Popup
        ...
        className={cn(
          // max-h + overflow-y-auto : centrée par translate, une fenêtre plus
          // haute que l'écran débordait des deux côtés, et la page derrière
          // est verrouillée — ses boutons devenaient inatteignables.
