    ...
    <div className="min-h-screen bg-background pt-24 pb-16">
      <div className="max-w-lg mx-auto px-4">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-black text-foreground mb-2">Commande confirmée !</h1>
        ...
        {/* Details card */}
        <div className="bg-card rounded-2xl border p-6 space-y-4 mb-6">
        ...
        {/* Status info */}
        <div className="bg-[#F5A800]/10 border border-[#F5A800]/30 rounded-xl p-4 text-sm text-center text-foreground mb-8">
        ...
        <div className="flex flex-col sm:flex-row gap-3">
          ...
          <Link href="/"
            className="flex-1 text-center border-2 border-border hover:border-[#F5A800] text-foreground font-bold py-3 rounded-xl transition-all">
            Retour à l&apos;accueil
          </Link>
        </div>
      </div>
